...
class Server:
   def __init__(self):
        ...
        #read the parameter
        self.RPCSERVERIP = rospy.get_param("RPCSERVERIP", "192.168.101.147")
	...
	self.server.register_function(self.new_notify)
   ...
   #new function notify 
   #json_feedback is the completeness message  
   def new_notify(self,json_feedback):
       #publish completeness message of PR2 to DialogManager
       self.pub.publish(String(json_feedback))
       rospy.logwarn('NOTIFICATION OF WORK DONE..............')
       return self.confirmation
