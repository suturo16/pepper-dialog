...
class AsrSphinx:
   def __init__(self):
      try:
        ...
        self.NBTHREADS = rospy.get_param("NBTHREADS", "5")
        ...
        self.DATAPATH = rospy.get_param("DATAPATH", "data")
        self.ASRPATH= rospy.get_param("ASRPATH", "./CMU/sphinx-source/pocketsphinx/src/programs/pocketsphinx_continuous")
        self.ASRCWD=rospy.get_param("ASRCWD", "/home/franklin/Desktop/newtest/src/dialogsystem")
